...
| 隐私政策 URL | `https://github.com/tangmubai/SJTU-Login-Addon/blob/main/PRIVACY.md` | ✅ 已提供 |
...
- 需勾选三项开发者认证：
  ...
  - ✅ 不将用户数据用于与单一用途无关的目的
  - ✅ 不将用户数据用于确定信用度或放贷
- **隐私政策 URL**：`https://github.com/tangmubai/SJTU-Login-Addon/blob/main/PRIVACY.md`
